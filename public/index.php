        ...
        <div class="d-flex gap-3">
            ...
            <div class="flex-grow-1">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <span class="text-muted"><?= htmlspecialchars($quack['username']) ?> * <?= date('H:i', strtotime($quack['created_at'])) ?></span>
                </div>
